...
def load_system_instruction():
    ...
    try:
        path = os.path.join(os.path.dirname(__file__), "prompts", "system_instruction.md")
...
def generate_content_ai(tweet_data: Dict, media_path: str = None, feedback: str = None) -> Tuple[str, str, str, str]:
    """
