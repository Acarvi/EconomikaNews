...
def run_gui():
    ...
    btn_scout = create_modern_button(btn_row, "🔍 Viral Scout", trigger_cloud_scan, "#9b59b6")
    ...
    def run_viral_scout(hours=24, ignore_history=False, must_have_media=True):
        ...
        def scout_task():
            try:
                scout = ViralScout()
                status_manager.update(f"🚀 Iniciando X Viral Scout ({hours}h, Sens: {sensitivity_var.get()})...")
                ...
                def handle_results():
                    ...
                    if hits:
                        ...
                        status_manager.update(f"✨ Encontrados {len(hits)} tuits virales!")
